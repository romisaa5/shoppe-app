...
class Success<T> implements ProductsState<T> {
...
@override
String toString() {
  return 'ProductsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ProductsStateCopyWith<T, $Res> {
...
class Failure<T> implements ProductsState<T> {
...
@override
String toString() {
  return 'ProductsState<$T>.failure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ProductsStateCopyWith<T, $Res> {
