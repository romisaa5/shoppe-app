...
class Failure<T> implements ResendOtpState<T> {
...
@override
String toString() {
  return 'ResendOtpState<$T>.failure(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ResendOtpStateCopyWith<T, $Res> {
