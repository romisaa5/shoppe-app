...
class Error<T> implements VerifyEmailState<T> {
...
@override
String toString() {
  return 'VerifyEmailState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $VerifyEmailStateCopyWith<T, $Res> {
